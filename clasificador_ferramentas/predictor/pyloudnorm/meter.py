...
class Meter(object):
    ...
    def integrated_loudness(self, data):
        ...
        with warnings.catch_warnings():
            ...
            arr_loudness = np.array(l).transpose()
            print(arr_loudness.shape)
            arr_loudness=arr_loudness.reshape(1,24)#np.array
            #arr_loudness2= np.mean(arr_loudness, axis=1, keepdims=True).transpose()
