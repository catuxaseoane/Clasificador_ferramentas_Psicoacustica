...
def comp_roughness(signal, fs, overlap):
    ...
    fs : integer
        sampling frequency
    overlap : float
        overlapping coefficient for the time windows of 16ms
    ...
    # -----------------------------------Stage 0------------------------------------
    # -------Creation of overlapping frames of 16 ms from the input signal---------

    # Number of points within each frame according to the time resolution of xxx ms
